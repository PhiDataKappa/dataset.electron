...
export default class Home extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="homeContainer" data-tid="container">
          <h2 style={{color: '#f7f7f7', paddingTop: '10px', textAlign: 'center'}}>dataset.tools</h2>
          <br/>
          <div style={{display:"flex", alignItems:"center", flexDirection:"column"}}>
          <img style={{width:"40%", height:"40%"}} id="dwimg" src="../dist-assets/dw.logo_greyscale.svg"/>
